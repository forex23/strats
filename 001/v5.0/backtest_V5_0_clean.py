# V5.0h – clean reference script (part 1)

# V 5.0g – final patched version with warm-up drop
...
OUT_CSV = f"V5_0g_trades_{dt.date.today()}.csv"
...
if __name__ == "__main__":
    ...
    print(f"V 5.0g  |  trades = {len(log)}  |  saved → {OUT_CSV}")
